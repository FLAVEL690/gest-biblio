...
public class CategoryController {
    ...
    @PostMapping(path = "category", consumes = APPLICATION_JSON_VALUE)
    ...
    @GetMapping(path = "category/{id}", produces = APPLICATION_JSON_VALUE)
    public Category getCategoryById(@PathVariable int id){
        return this.categoryService.getCategoryById(id);
    }

    @PutMapping(path = "category/{id}" ,consumes = APPLICATION_JSON_VALUE)
